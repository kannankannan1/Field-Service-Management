...
SELECT w.id, NULL, 'NEW', NULL, '2026-08-15 09:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000001';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-15 09:30:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000002';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-15 09:35:00', 'Assigned to Jordan Lee'
FROM work_orders w WHERE w.work_order_number = 'WO-000002';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-13 10:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000003';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-13 10:05:00', 'Assigned to Jordan Lee'
FROM work_orders w WHERE w.work_order_number = 'WO-000003';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'ASSIGNED', 'IN_PROGRESS', (SELECT id FROM users WHERE username = 'tech1'), '2026-08-14 08:15:00', 'Technician started work'
FROM work_orders w WHERE w.work_order_number = 'WO-000003';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-12 14:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000004';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-12 14:10:00', 'Assigned to Casey Kim'
FROM work_orders w WHERE w.work_order_number = 'WO-000004';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'ASSIGNED', 'IN_PROGRESS', (SELECT id FROM users WHERE username = 'tech2'), '2026-08-13 09:20:00', 'Technician started work'
FROM work_orders w WHERE w.work_order_number = 'WO-000004';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'IN_PROGRESS', 'ON_HOLD', (SELECT id FROM users WHERE username = 'tech2'), '2026-08-13 11:00:00', 'Waiting for part delivery'
FROM work_orders w WHERE w.work_order_number = 'WO-000004';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-11 08:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000005';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-11 08:10:00', 'Assigned to Casey Kim'
FROM work_orders w WHERE w.work_order_number = 'WO-000005';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'ASSIGNED', 'IN_PROGRESS', (SELECT id FROM users WHERE username = 'tech2'), '2026-08-14 13:30:00', 'Technician started work'
FROM work_orders w WHERE w.work_order_number = 'WO-000005';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-04 09:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000006';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-04 09:05:00', 'Assigned to Jordan Lee'
FROM work_orders w WHERE w.work_order_number = 'WO-000006';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'ASSIGNED', 'IN_PROGRESS', (SELECT id FROM users WHERE username = 'tech1'), '2026-08-05 08:10:00', 'Technician started work'
FROM work_orders w WHERE w.work_order_number = 'WO-000006';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'IN_PROGRESS', 'COMPLETED', (SELECT id FROM users WHERE username = 'tech1'), '2026-08-05 11:40:00', 'Job completed by technician'
FROM work_orders w WHERE w.work_order_number = 'WO-000006';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-02 13:30:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000007';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'NEW', 'ASSIGNED', (SELECT id FROM users WHERE username = 'dispatcher1'), '2026-08-02 13:40:00', 'Assigned to Casey Kim'
FROM work_orders w WHERE w.work_order_number = 'WO-000007';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'ASSIGNED', 'IN_PROGRESS', (SELECT id FROM users WHERE username = 'tech2'), '2026-08-02 14:15:00', 'Technician started work'
FROM work_orders w WHERE w.work_order_number = 'WO-000007';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'IN_PROGRESS', 'COMPLETED', (SELECT id FROM users WHERE username = 'tech2'), '2026-08-02 16:50:00', 'Job completed by technician'
FROM work_orders w WHERE w.work_order_number = 'WO-000007';
INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, 'COMPLETED', 'CLOSED', (SELECT id FROM users WHERE username = 'manager1'), '2026-08-03 09:00:00', 'Work order closed by manager'
FROM work_orders w WHERE w.work_order_number = 'WO-000007';

INSERT INTO work_order_status_history (work_order_id, from_status, to_status, changed_by_id, changed_at, note)
SELECT w.id, NULL, 'NEW', NULL, '2026-08-15 11:00:00', 'Work order created'
FROM work_orders w WHERE w.work_order_number = 'WO-000008';
